  ...
  actions: {
    fetchCustomers(ctx, queryParams) {
      return new Promise((resolve, reject) => {
        axios
          .get(buildServiceUrl('/category'), { params: queryParams })
    ...
    fetchCustomer(ctx, { id }) {
      ...
      return new Promise((resolve, reject) => {
        axios
          .get(buildServiceUrl(`/category/${id}`))
          .then(response => resolve(response))
          .catch(error => reject(error))
      })
    },
    addCustomer(ctx, customerData) {
      axios
        .post(buildServiceUrl('/category'), customerData)
    ...
    deleteCustomer(ctx, id) {
      return new Promise((resolve, reject) => {
        axios
          .delete(buildServiceUrl(`/category/${id}`))
          .then(response => resolve(response))
          .catch(error => reject(error))
      })
    },
