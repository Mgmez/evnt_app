  ...
  actions: {
    fetchCustomers(ctx, queryParams) {
      return new Promise((resolve, reject) => {
        axios
          .get(buildServiceUrl('/role'), { params: queryParams })
    ...
    addCustomer(ctx, customerData) {
      axios
        .post(buildServiceUrl('/role'), customerData)
    ...
    updateCustomer(ctx, { id, data }) {
      ...
      const update = new Promise((resolve, reject) => {
        delete payload.user
        axios
          .patch(buildServiceUrl(`/role/${id}`), payload)
          .then(response => resolve(response))
          .catch(error => reject(error))
      })
    ...
    deleteCustomer(ctx, id) {
      return new Promise((resolve, reject) => {
        axios
          .delete(buildServiceUrl(`/role/${id}`))
          .then(response => resolve(response))
          .catch(error => reject(error))
      })
    },
