        ...
        <b-row>
          ...
          >
            <div class="d-flex align-items-center justify-content-end">
              ...
              >
                <span class="text-nowrap">Añadir Sub Categoria</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      >
        ...
        <template #cell(opciones)="data">
          ...
          >
            ...
            <b-dropdown-item :to="{ name: 'subcategories-edit', params: { id: data.item.id } }">
...
import SubCategoryListAddNew from './SubCategoryListAddNew.vue'
