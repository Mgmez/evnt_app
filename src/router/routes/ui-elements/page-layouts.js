export default [
  {
    ...
    component: () => import('@/views2/ui/page-layouts/CollapsedMenu.vue'),
    meta: {
  ...
  },
  {
    ...
    component: () => import('@/views2/ui/page-layouts/BoxedLayout.vue'),
    meta: {
  ...
  },
  {
    ...
    component: () => import('@/views2/ui/page-layouts/WithoutMenu.vue'),
    meta: {
  ...
  },
  {
    ...
    component: () => import('@/views2/ui/page-layouts/LayoutEmpty.vue'),
    meta: {
  ...
  },
  {
    ...
    component: () => import('@/views2/ui/page-layouts/LayoutBlank.vue'),
    meta: {
      layout: 'full',
